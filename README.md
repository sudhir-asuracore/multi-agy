...
- **🛡️ True Process & Session Isolation**:
...
### 1. Prerequisites
- Linux / Ubuntu (with `bubblewrap` pre-installed: `sudo apt install bubblewrap`)
- Python 3.8+
...
### 1. Add a New Profile & Authenticate
```bash
